...
CONFIG: Final[dict] = {
    ...
    "request_timeout": 40,
    # Deliberately modest. Raising this to 5 made things measurably worse in
    # CI: more requests against an already-hostile endpoint got the whole
    # runner IP range refused. A blocked host is now skipped for the rest of
    # the run (circuit breaker in http.py) instead of being retried per target.
    "max_retries": 3,
